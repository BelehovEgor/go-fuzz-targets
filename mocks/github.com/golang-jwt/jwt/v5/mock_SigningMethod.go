...
func (_m *MockSigningMethod) Sign(signingString string, key interface{}) ([]byte, error) {
...
func (_c *MockSigningMethod_Sign_Call) Run(run func(signingString string, key interface{})) *MockSigningMethod_Sign_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockSigningMethod_Sign_Call) RunAndReturn(run func(string, interface{}) ([]byte, error)) *MockSigningMethod_Sign_Call {
	_c.Call.Return(run)
	return _c
}

// Verify provides a mock function with given fields: signingString, sig, key
func (_m *MockSigningMethod) Verify(signingString string, sig []byte, key interface{}) error {
...
func (_c *MockSigningMethod_Verify_Call) Run(run func(signingString string, sig []byte, key interface{})) *MockSigningMethod_Verify_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockSigningMethod_Verify_Call) RunAndReturn(run func(string, []byte, interface{}) error) *MockSigningMethod_Verify_Call {
	_c.Call.Return(run)
	return _c
}
